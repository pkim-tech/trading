"""COPY of sim_minute_groundtruth_independent.py, forked 2026-08-25 to add a
1-second-vs-1-minute granularity comparison mode WITHOUT touching the
original validated script (per user instruction -- the original is the
mandatory parity-gate reference for the production GT kernel,
tests/test_ground_truth_kernel_parity.py, and must stay untouched).
