...
SCENARIOS = {
    ...
    "fast_path_partial_fill": "fake_venue.scenarios_fast_path_partial_fill",
    "confirmed_fill_dropped_at_gate": "fake_venue.scenarios_confirmed_fill_dropped_at_gate",
    "sl_order_fills_independent_detection": "fake_venue.scenarios_sl_order_fills_independent_detection",
    "replace_target_mismatch": "fake_venue.scenarios_replace_target_mismatch",
    "abnormal_drift_alert": "fake_venue.scenarios_abnormal_drift_alert",
    "addon_reject": "fake_venue.scenarios_addon_reject",
    "addon_lifecycle": "fake_venue.scenarios_addon_lifecycle",
    "addon_reconciliation": "fake_venue.scenarios_addon_reconciliation",
    "addon_leg_independent_sl_fill_detection": "fake_venue.scenarios_addon_leg_independent_sl_fill_detection",
    "drought_handoff": "fake_venue.scenarios_drought_handoff",
    "sl_sync_placement": "fake_venue.scenarios_sl_sync_placement",
    "order_retry_duplicate_prevented": "fake_venue.scenarios_retry_duplicate_prevented",
    "gap_resize": "fake_venue.scenarios_gap_resize",
    "sl_async_fallback": "fake_venue.scenarios_sl_async_fallback",
    "market_buy_placement": "fake_venue.scenarios_market_buy_placement",
    "orphaned_broker_position": "fake_venue.scenarios_orphaned_broker_position",
    "time_exit_trigger_armed": "fake_venue.scenarios_time_exit_trigger_armed",
    "entry_abandon_timeout": "fake_venue.scenarios_entry_abandon_timeout",
    "node_circuit_breaker": "fake_venue.scenarios_node_circuit_breaker",
    "dup_order_retry_after_failure": "fake_venue.scenarios_dup_order_retry_after_failure",
    "canary_full_lifecycle": "fake_venue.scenarios_canary_full_lifecycle",
    "canary_early_sl": "fake_venue.scenarios_canary_early_sl",
    "automated_sell_execution": "fake_venue.scenarios_automated_sell_execution",
    "trade_log_shares_stale_at_close": "fake_venue.scenarios_trade_log_shares_stale_at_close",
    "automated_exit_execution": "fake_venue.scenarios_automated_exit_execution",
    "ery_nontrading_day_phantom_fill": "fake_venue.scenarios_ery_nontrading_day_phantom_fill",
}
