...
**Still open, separate**: `schwab_token.json` (`schwab_auth.TOKEN_PATH`) mutation during the original incident's 08:10-08:32 window is unrelated to this fix (different module, no env override, no test reaches it un-mocked) and remains unexplained — see `docs/backlog_cache.md`'s narrowed entry.
