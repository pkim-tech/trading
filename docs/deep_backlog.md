...
## ✅ [backtest] Built 2026-08-09 — `scripts/candidate_full_review.py`, the canonical "everything at a glance" candidate-screening report; paired Fable+Opus review found 2 HIGH + several MEDIUM real bugs, all fixed
