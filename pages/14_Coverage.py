...
def load_accountability_grid():
    ...
    for r in REGISTRY:
        ...
        fake_broker, fake_broker_detail = fake_broker_proof_for(r.get('scenario_key'))
        rows.append({
            ...
            "fake_broker proof": f"{OFFLINE_PROOF_EMOJI.get(fake_broker, '?')} {fake_broker_detail}".strip(),
